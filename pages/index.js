        ...
        <div className="flex-1 p-10 text-right text-gray-700">
          ...
          <div className='flex justify-end firstSection'>
              ...
              <div className='bg-[#14B8A6] rounded py-1 p-[3px] w-1/4 h-fit mt-[0px]'>
                <img src='/aarchive/images/MSA.png' className='bg-white bg-gradient-to-r from-[#14B8A6] to-white-100'></img>
              </div>
            ...
            <div className='flex justify-end firstSection'>
              <div className='small-boxes px-[10px] w-4/6  justify-end'>
                ...
                <label htmlFor="fileUpload">اختيار الملف</label>
                  ...
                  <input 
                    type="file"
                    className="w-full p-2 pt-3 pl-3 text-right border-2 border-gray-500 rounded-md focus:border-teal-500 focus:ring-teal-500"
                    id="fileUpload"
                    ref={fileInputRef}
